...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--results-dir",
        type=Path,
        default=Path("./output/advection_convergence_space"),
...
def make_plots(results_dir: Path, all_results: Dict[str, List[Dict[str, float]]]) -> None:
    ...
    ax.set_title("DGmini advection spatial convergence after one period")
...
def main() -> int:
    ...
    exact = make_initial_condition_function(INITIAL_CONDITION_EXPRESSION)
