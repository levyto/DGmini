...
def parse_args() -> argparse.Namespace:
  ...
  parser.add_argument("--results-dir", type=Path,  default=Path("./output/burgers_convergence_time"), help="Directory where generated configs, outputs, tables, and plots are stored.")
...
def main() -> int:
  ...
  for integrator in args.integrators:
    ...
    print_time_table("DGmini Burgers temporal convergence", rows)
  # end for integrator
  ...
  make_plot(
    ...
    title="DGmini Burgers temporal convergence before shock formation", 
